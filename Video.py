...
class Video:
    ...
    def __init__(self, title, code, thumbnail, author, viewCount, length, publishedText, authorId):
        self.title = title
        self.code = code
    ...
    def getData(self):
        videoRes = requests.get("https://vid.puffyan.us/api/v1/videos/" + self.code)
